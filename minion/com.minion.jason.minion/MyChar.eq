...
public class MyChar: SEEntity
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("char", "char", 0.10*get_scene_width(), 0.15*get_scene_height());
		rsc.prepare_image("banana", "banana", 0.04*get_scene_width(), 0.08*get_scene_height());
	...
	public void tick(TimeVal now, double delta) {
		...
		banana= add_sprite_for_image(SEImage.for_resource("banana"));
			banana.move(char.get_x(), char.get_y());
		}
